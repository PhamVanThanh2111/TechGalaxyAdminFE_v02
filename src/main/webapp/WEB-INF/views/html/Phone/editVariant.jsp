        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="/products/variants/update/2" method="post" enctype="multipart/form-data">
                            <!-- Name -->
                            <div class="form-group">
                                <label for="variantName">Name</label>
                                <input type="text" class="form-control" id="variantName" name="name"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="variantDescription" name="description"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="variantContent" name="content"
                                          rows="5">${variant.content}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="variantStatus" name="status">
                                    <option value="AVAILABLE"
                                            <c:if test="${variant.status eq 'AVAILABLE'}">selected</c:if>>Available
                                    </option>
                                    <option value="OUT_OF_STOCK"
                                            <c:if test="${variant.status eq 'OUT_OF_STOCK'}">selected</c:if>>Out of
                                        Stock
                                    </option>
                                    <option value="DISCONTINUED"
                                            <c:if test="${variant.status eq 'DISCONTINUED'}">selected</c:if>>
                                        Discontinued
                                    </option>
                                </select>
                            </div>
